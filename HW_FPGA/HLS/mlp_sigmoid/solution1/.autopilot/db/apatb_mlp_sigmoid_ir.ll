; ModuleID = '/home/steve/Desktop/capstone/test_vivado/pynq_training/mlp_sigmoid/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_mlp_sigmoid_ir(%"class.hls::stream"* %S_AXIS, %"class.hls::stream"* %M_AXIS) local_unnamed_addr #0 {
entry:
  %S_AXIS_copy = alloca %"class.hls::stream", align 512
  %M_AXIS_copy = alloca %"class.hls::stream", align 512
  call fastcc void @copy_in(%"class.hls::stream"* %S_AXIS, %"class.hls::stream"* nonnull align 512 %S_AXIS_copy, %"class.hls::stream"* %M_AXIS, %"class.hls::stream"* nonnull align 512 %M_AXIS_copy)
  call void @apatb_mlp_sigmoid_hw(%"class.hls::stream"* %S_AXIS_copy, %"class.hls::stream"* %M_AXIS_copy)
  call fastcc void @copy_out(%"class.hls::stream"* %S_AXIS, %"class.hls::stream"* nonnull align 512 %S_AXIS_copy, %"class.hls::stream"* %M_AXIS, %"class.hls::stream"* nonnull align 512 %M_AXIS_copy)
  ret void
}
...
; <label>:26:                                     ; preds = %23
  call fastcc void @streamcpy_hls.p0struct.ap_int_base.0(%struct.ap_int_base.0* %.01.1.013, %struct.ap_int_base.0* %.0.1.012)
  br label %34
...
; <label>:30:                                     ; preds = %27
  call fastcc void @streamcpy_hls.p0struct.ssdm_int.1(%struct.ssdm_int.1* %.01.1.0.015, %struct.ssdm_int.1* %.0.1.0.014)
  br label %34
...
; <label>:64:                                     ; preds = %61, %60, %56, %52
  ...
  %65 = bitcast %struct.ap_uint.2* %.0.434 to i8*
...
; <label>:68:                                     ; preds = %64
  ...
  %69 = bitcast %struct.ap_int_base.3* %.0.4.036 to i8*
...
; <label>:72:                                     ; preds = %68
  ...
  %73 = bitcast %struct.ssdm_int.4* %.0.4.0.038 to i8*
...
; <label>:79:                                     ; preds = %76, %75, %71, %67
  ...
  %80 = bitcast %struct.ap_uint.2* %.0.542 to i8*
...
; <label>:83:                                     ; preds = %79
  ...
  %84 = bitcast %struct.ap_int_base.3* %.0.5.044 to i8*
...
; <label>:87:                                     ; preds = %83
  ...
  %88 = bitcast %struct.ssdm_int.4* %.0.5.0.046 to i8*
...
; <label>:94:                                     ; preds = %91, %90, %86, %82
  ...
  %95 = bitcast %struct.ap_uint.2* %.0.650 to i8*
...
; <label>:98:                                     ; preds = %94
  ...
  %99 = bitcast %struct.ap_int_base.3* %.0.6.052 to i8*
...
; <label>:102:                                    ; preds = %98
  ...
  %103 = bitcast %struct.ssdm_int.4* %.0.6.0.054 to i8*
...
declare void @apatb_mlp_sigmoid_hw(%"class.hls::stream"*, %"class.hls::stream"*)

define void @mlp_sigmoid_hw_stub_wrapper(%"class.hls::stream"*, %"class.hls::stream"*) #6 {
entry:
  call void @copy_out(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream"* null, %"class.hls::stream"* %1)
  call void @mlp_sigmoid_hw_stub(%"class.hls::stream"* %0, %"class.hls::stream"* %1)
  call void @copy_in(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream"* null, %"class.hls::stream"* %1)
  ret void
}

declare void @mlp_sigmoid_hw_stub(%"class.hls::stream"*, %"class.hls::stream"*)
