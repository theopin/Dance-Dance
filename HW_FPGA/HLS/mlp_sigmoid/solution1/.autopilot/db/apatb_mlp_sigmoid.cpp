...
// wrapc file define:
#define AUTOTB_TVIN_S_AXIS_V_data_V "../tv/cdatafile/c.mlp_sigmoid.autotvin_S_AXIS_V_data_V.dat"
#define AUTOTB_TVOUT_S_AXIS_V_data_V "../tv/cdatafile/c.mlp_sigmoid.autotvout_S_AXIS_V_data_V.dat"
#define AUTOTB_TVIN_S_AXIS_V_keep_V "../tv/cdatafile/c.mlp_sigmoid.autotvin_S_AXIS_V_keep_V.dat"
#define AUTOTB_TVOUT_S_AXIS_V_keep_V "../tv/cdatafile/c.mlp_sigmoid.autotvout_S_AXIS_V_keep_V.dat"
#define AUTOTB_TVIN_S_AXIS_V_strb_V "../tv/cdatafile/c.mlp_sigmoid.autotvin_S_AXIS_V_strb_V.dat"
#define AUTOTB_TVOUT_S_AXIS_V_strb_V "../tv/cdatafile/c.mlp_sigmoid.autotvout_S_AXIS_V_strb_V.dat"
#define AUTOTB_TVIN_S_AXIS_V_last_V "../tv/cdatafile/c.mlp_sigmoid.autotvin_S_AXIS_V_last_V.dat"
#define AUTOTB_TVOUT_S_AXIS_V_last_V "../tv/cdatafile/c.mlp_sigmoid.autotvout_S_AXIS_V_last_V.dat"
...
// wrapc file define:
#define AUTOTB_TVIN_M_AXIS_V_data_V "../tv/cdatafile/c.mlp_sigmoid.autotvin_M_AXIS_V_data_V.dat"
#define AUTOTB_TVOUT_M_AXIS_V_data_V "../tv/cdatafile/c.mlp_sigmoid.autotvout_M_AXIS_V_data_V.dat"
#define AUTOTB_TVIN_M_AXIS_V_keep_V "../tv/cdatafile/c.mlp_sigmoid.autotvin_M_AXIS_V_keep_V.dat"
#define AUTOTB_TVOUT_M_AXIS_V_keep_V "../tv/cdatafile/c.mlp_sigmoid.autotvout_M_AXIS_V_keep_V.dat"
#define AUTOTB_TVIN_M_AXIS_V_strb_V "../tv/cdatafile/c.mlp_sigmoid.autotvin_M_AXIS_V_strb_V.dat"
#define AUTOTB_TVOUT_M_AXIS_V_strb_V "../tv/cdatafile/c.mlp_sigmoid.autotvout_M_AXIS_V_strb_V.dat"
#define AUTOTB_TVIN_M_AXIS_V_last_V "../tv/cdatafile/c.mlp_sigmoid.autotvin_M_AXIS_V_last_V.dat"
#define AUTOTB_TVOUT_M_AXIS_V_last_V "../tv/cdatafile/c.mlp_sigmoid.autotvout_M_AXIS_V_last_V.dat"
...
// tvout file define:
#define AUTOTB_TVOUT_PC_S_AXIS_V_data_V "../tv/rtldatafile/rtl.mlp_sigmoid.autotvout_S_AXIS_V_data_V.dat"
#define AUTOTB_TVOUT_PC_S_AXIS_V_keep_V "../tv/rtldatafile/rtl.mlp_sigmoid.autotvout_S_AXIS_V_keep_V.dat"
#define AUTOTB_TVOUT_PC_S_AXIS_V_strb_V "../tv/rtldatafile/rtl.mlp_sigmoid.autotvout_S_AXIS_V_strb_V.dat"
#define AUTOTB_TVOUT_PC_S_AXIS_V_last_V "../tv/rtldatafile/rtl.mlp_sigmoid.autotvout_S_AXIS_V_last_V.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_M_AXIS_V_data_V "../tv/rtldatafile/rtl.mlp_sigmoid.autotvout_M_AXIS_V_data_V.dat"
#define AUTOTB_TVOUT_PC_M_AXIS_V_keep_V "../tv/rtldatafile/rtl.mlp_sigmoid.autotvout_M_AXIS_V_keep_V.dat"
#define AUTOTB_TVOUT_PC_M_AXIS_V_strb_V "../tv/rtldatafile/rtl.mlp_sigmoid.autotvout_M_AXIS_V_strb_V.dat"
#define AUTOTB_TVOUT_PC_M_AXIS_V_last_V "../tv/rtldatafile/rtl.mlp_sigmoid.autotvout_M_AXIS_V_last_V.dat"
...
extern "C" void mlp_sigmoid_hw_stub_wrapper(volatile void *, volatile void *);
    ...
    string AESL_num;long __xlx_apatb_param_S_AXIS_stream_buf_final_size;
{
  ...
  for (long i = 0; i < __xlx_apatb_param_S_AXIS_stream_buf_final_size; ++i)((hls::stream<__cosim_sC__>*)__xlx_apatb_param_S_AXIS)->read();
{sc_bv<96> xlx_stream_M_AXIS_pc_buffer;
unsigned xlx_stream_M_AXIS_size = 0;

          std::vector<sc_bv<32> > M_AXIS_V_data_V_pc_buffer_Copy;
{
      static ifstream rtl_tv_out_file;
      if (!rtl_tv_out_file.is_open()) {
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<32> > M_AXIS_V_data_V_pc_buffer;
          int i = 0;
...
M_AXIS_V_data_V_pc_buffer_Copy=M_AXIS_V_data_V_pc_buffer;
          ...
          std::vector<sc_bv<32> > M_AXIS_V_keep_V_pc_buffer_Copy;
{
      static ifstream rtl_tv_out_file;
      if (!rtl_tv_out_file.is_open()) {
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<32> > M_AXIS_V_keep_V_pc_buffer;
          int i = 0;
...
M_AXIS_V_keep_V_pc_buffer_Copy=M_AXIS_V_keep_V_pc_buffer;
          ...
          std::vector<sc_bv<32> > M_AXIS_V_strb_V_pc_buffer_Copy;
{
      static ifstream rtl_tv_out_file;
      if (!rtl_tv_out_file.is_open()) {
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<32> > M_AXIS_V_strb_V_pc_buffer;
          int i = 0;
...
M_AXIS_V_strb_V_pc_buffer_Copy=M_AXIS_V_strb_V_pc_buffer;
          ...
          std::vector<sc_bv<32> > M_AXIS_V_last_V_pc_buffer_Copy;
{
      static ifstream rtl_tv_out_file;
      if (!rtl_tv_out_file.is_open()) {
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<32> > M_AXIS_V_last_V_pc_buffer;
          int i = 0;
...
xlx_stream_M_AXIS_pc_buffer.range(31, 0) = M_AXIS_V_data_V_pc_buffer_Copy[j];
xlx_stream_M_AXIS_pc_buffer.range(39, 32) = M_AXIS_V_keep_V_pc_buffer_Copy[j];
xlx_stream_M_AXIS_pc_buffer.range(47, 40) = M_AXIS_V_strb_V_pc_buffer_Copy[j];
xlx_stream_M_AXIS_pc_buffer.range(63, 56) = M_AXIS_V_last_V_pc_buffer_Copy[j];
__cosim_sC__ xlx_stream_elt;
((long long*)&xlx_stream_elt)[0*1+0] = xlx_stream_M_AXIS_pc_buffer.range(63,0).to_int64();
((long long*)&xlx_stream_elt)[0*1+1] = xlx_stream_M_AXIS_pc_buffer.range(95,64).to_int64();
((hls::stream<__cosim_sC__>*)__xlx_apatb_param_M_AXIS)->write(xlx_stream_elt);
}}
    AESL_transaction_pc++;
    return ;
  }
...
std::vector<__cosim_sC__> __xlx_apatb_param_S_AXIS_stream_buf;
{
  while (!((hls::stream<__cosim_sC__>*)__xlx_apatb_param_S_AXIS)->empty())
    __xlx_apatb_param_S_AXIS_stream_buf.push_back(((hls::stream<__cosim_sC__>*)__xlx_apatb_param_S_AXIS)->read());
  for (int i = 0; i < __xlx_apatb_param_S_AXIS_stream_buf.size(); ++i)
    ((hls::stream<__cosim_sC__>*)__xlx_apatb_param_S_AXIS)->write(__xlx_apatb_param_S_AXIS_stream_buf[i]);
  }
long __xlx_apatb_param_S_AXIS_stream_buf_size = ((hls::stream<__cosim_sC__>*)__xlx_apatb_param_S_AXIS)->size();
std::vector<__cosim_sC__> __xlx_apatb_param_M_AXIS_stream_buf;
long __xlx_apatb_param_M_AXIS_stream_buf_size = ((hls::stream<__cosim_sC__>*)__xlx_apatb_param_M_AXIS)->size();
CodeState = CALL_C_DUT;
mlp_sigmoid_hw_stub_wrapper(__xlx_apatb_param_S_AXIS, __xlx_apatb_param_M_AXIS);
CodeState = DUMP_OUTPUTS;
long __xlx_apatb_param_S_AXIS_stream_buf_final_size = __xlx_apatb_param_S_AXIS_stream_buf_size - ((hls::stream<__cosim_sC__>*)__xlx_apatb_param_S_AXIS)->size();
...
__xlx_tmp_lv.range(63,0) = ((long long*)&__xlx_apatb_param_S_AXIS_stream_buf[j])[0*1+0];
__xlx_tmp_lv.range(95,64) = ((long long*)&__xlx_apatb_param_S_AXIS_stream_buf[j])[0*1+1];
...
long __xlx_apatb_param_M_AXIS_stream_buf_final_size = ((hls::stream<__cosim_sC__>*)__xlx_apatb_param_M_AXIS)->size() - __xlx_apatb_param_M_AXIS_stream_buf_size;
{
  while (!((hls::stream<__cosim_sC__>*)__xlx_apatb_param_M_AXIS)->empty())
    __xlx_apatb_param_M_AXIS_stream_buf.push_back(((hls::stream<__cosim_sC__>*)__xlx_apatb_param_M_AXIS)->read());
  for (int i = 0; i < __xlx_apatb_param_M_AXIS_stream_buf.size(); ++i)
    ((hls::stream<__cosim_sC__>*)__xlx_apatb_param_M_AXIS)->write(__xlx_apatb_param_M_AXIS_stream_buf[i]);
  }
...
sc_bv<96> __xlx_tmp_lv;
__xlx_tmp_lv.range(63,0) = ((long long*)&__xlx_apatb_param_M_AXIS_stream_buf[__xlx_apatb_param_M_AXIS_stream_buf_size+j])[0*1+0];
__xlx_tmp_lv.range(95,64) = ((long long*)&__xlx_apatb_param_M_AXIS_stream_buf[__xlx_apatb_param_M_AXIS_stream_buf_size+j])[0*1+1];
sc_bv<32> __xlx_tmp_0_lv = __xlx_tmp_lv.range(31, 0);
sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_0_lv.to_string(SC_HEX).c_str());
aesl_fh.write(AUTOTB_TVOUT_M_AXIS_V_data_V, __xlx_sprintf_buffer.data());
sc_bv<8> __xlx_tmp_1_lv = __xlx_tmp_lv.range(39, 32);
